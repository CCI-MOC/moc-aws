...
locals {
  sso_groups = {
    ...
    "moc-aws-cluster-operators"         = "Provides Secrets Manager access and write access to the OAC OIDC bucket for deploying OpenShift clusters.",
    "moc-tofu-makers"                   = "Provides read/write access to tofu state bucket",
  }
}
