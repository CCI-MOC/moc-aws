...
| <a name="input_eso_readable_secret_prefixes"></a> [eso\_readable\_secret\_prefixes](#input\_eso\_readable\_secret\_prefixes) | List of additional Secrets Manager name prefixes that ESO is allowed to read | `list(string)` | `[]` | no |
